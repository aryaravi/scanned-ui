...
const Banner = () => {
    ...
    return (
        <>
            <div className="ma__brand-banner ma__brand-banner--c-primary-alt-bg-dark container_padding brand_banner">
                <button
                    className="ma__brand-banner-container banner_btn"
                ...
                >
                    <img
                        ...
                        src="https://unpkg.com/@massds/mayflower-assets@12.7.0/static/images/logo/stateseal-white.png"
                        alt="Massachusetts State Seal"
                    />
                    <div className="ma__brand-banner-text">
                        <span>An official website of the Commonwealth of Massachusetts.  </span>
                        <span
                            className="ma__brand-banner-button ma__button-icon ma__icon-small ma__button-icon--quaternary ma__button-icon--c-white"
                ...
                <ul className={`ma__brand-banner-expansion ${isExpanded ? 'banner_expand' : 'banner_close'}`} id="ma__brand-banner-content">
